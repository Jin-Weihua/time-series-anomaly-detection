...
import chart_studio
chart_studio.tools.set_credentials_file(username='wh.jin', api_key='DADs4nY8rboe9LuL6Iuz')
# import plotly
...
result_name = 'result/{}/{}-prd1-470'.format(model_name,model_name)
...
pio.write_html(fig, file='{}.html'.format(result_name), auto_open=True)
