...
fig1 = plt.figure(figsize=(14, 5),dpi=300)
...
plt.subplots_adjust(left=0.05, bottom=0.15, right=0.95, top=0.90, hspace=0.4, wspace=0.4)
# left=0.05, bottom=0.03, right=0.95, top=0.97 分别代表到画布的左侧和底部的距离占整幅图宽和高的比例
# plt.show()
plt.savefig('result/3.eps',format='eps')
plt.savefig('result/3.tiff',format='tiff')
