...
if DO_TRAINING:
    ...
    weight_file_path = 'model/{}/{}.h5'.format(model_name,'autoencoder9-weights1.500-0.00030308')
...
data_target.to_csv('result/{}/{}-prd1-500.csv'.format(model_name,model_name), encoding='utf-8')
