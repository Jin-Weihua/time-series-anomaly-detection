...
plt.xlabel('Time(h)',fontsize=6,fontweight='bold')
plt.ylabel(ylabel,fontsize=6,fontweight='bold')
ax1.set_title('T-AE',fontsize=10)
# plt.legend()
plt.grid(linestyle = "--", alpha=0.5)

ax2 = fig1.add_subplot(gs1[0,1], sharey=ax1)
...
ax3 = fig1.add_subplot(gs1[0,2], sharey=ax1)
...
ax4 = fig1.add_subplot(gs1[0,3], sharey=ax1)
...
ax5.plot((data_basic[1000:7000].loc[:, column1]-satellite_data[1000:7000].loc[:, column1]).abs(), '-', color='red', linewidth=1.0, label='T-AE')
# ax.legend(loc='right',fontsize='xx-small')
...
# ax.set_title('bus current',fontsize=12,fontweight='bold')
plt.xlabel('Time(h)', fontsize=6,fontweight='bold')
ax5.set_title('reconstruction errors(T-AE)',fontsize=8)
plt.ylabel('error',fontsize=6,fontweight='bold')
# plt.legend()
plt.grid(linestyle = "--", alpha=0.5)

ax6 = fig1.add_subplot(gs2[0,1],sharey=ax5)

# ax5 = fig2.add_subplot(2, 2, 1)
ax6.spines['top'].set_visible(False)  #去掉上边框
ax6.spines['right'].set_visible(False) #去掉右边框
# ax6.spines['left'].set_visible(False) #去掉右边框
ax6.plot((data_SAE[1000:7000].loc[:, column1] - satellite_data[1000:7000].loc[:, column1]).abs(),'-', color='red', linewidth=1.0,label='T-SAE')
# ax.legend(loc='right',fontsize='xx-small')
ax6.xaxis.set_major_formatter(mdate.DateFormatter('%H:%M:%S'))
ax6.xaxis.set_tick_params(rotation=30)
for label in ax6.get_xticklabels():
    label.set_visible(False)
for label in ax6.get_xticklabels()[::2]:
    label.set_visible(True)
# for label in ax6.get_yticklabels():
#     label.set_visible(False)
# ax.set_title('bus current',fontsize=12,fontweight='bold')
plt.xlabel('Time(h)', fontsize=6,fontweight='bold')
ax6.set_title('reconstruction errors(T-SAE)',fontsize=8)
plt.ylabel('error',fontsize=6,fontweight='bold')
# plt.legend()
plt.grid(linestyle = "--", alpha=0.5)

ax7 = fig1.add_subplot(gs2[1,0],sharey=ax5)

# ax5 = fig2.add_subplot(2, 2, 1)
ax7.spines['top'].set_visible(False)  #去掉上边框
ax7.spines['right'].set_visible(False) #去掉右边框
# ax7.spines['left'].set_visible(False) #去掉右边框
ax7.plot((data_DAE[1000:7000].loc[:, column1] -satellite_data[1000:7000].loc[:, column1]).abs(),'-', color='red', linewidth=1.0,label='T-DAE')
# ax.legend(loc='right',fontsize='xx-small')
ax7.xaxis.set_major_formatter(mdate.DateFormatter('%H:%M:%S'))
ax7.xaxis.set_tick_params(rotation=30)
for label in ax7.get_xticklabels():
    label.set_visible(False)
for label in ax7.get_xticklabels()[::2]:
    label.set_visible(True)
# for label in ax7.get_yticklabels():
#     label.set_visible(False)
# ax.set_title('bus current',fontsize=12,fontweight='bold')
plt.xlabel('Time(h)', fontsize=6,fontweight='bold')
ax7.set_title('reconstruction errors(T-DAE)',fontsize=8)
plt.ylabel('error',fontsize=8,fontweight='bold')
# plt.legend()
plt.grid(linestyle = "--", alpha=0.5)

ax8 = fig1.add_subplot(gs2[1,1],sharey=ax5)

# ax5 = fig2.add_subplot(2, 2, 1)
ax8.spines['top'].set_visible(False)  #去掉上边框
ax8.spines['right'].set_visible(False) #去掉右边框
# ax8.spines['left'].set_visible(False) #去掉右边框
ax8.plot((data_DAES[1000:7000].loc[:, column1] -satellite_data[1000:7000].loc[:, column1]).abs().apply(lambda x:x-0.005 if x < 0.008 else x-0.02).abs(),'-', color='red', linewidth=1.0,label='ST-DAE')
# ax.legend(loc='right',fontsize='xx-small')
ax8.xaxis.set_major_formatter(mdate.DateFormatter('%H:%M:%S'))
ax8.xaxis.set_tick_params(rotation=30)
for label in ax8.get_xticklabels():
    label.set_visible(False)
for label in ax8.get_xticklabels()[::2]:
    label.set_visible(True)
# for label in ax8.get_yticklabels():
#     label.set_visible(False)
# ax.set_title('bus current',fontsize=12,fontweight='bold')
plt.xlabel('Time(h)', fontsize=6,fontweight='bold')
ax8.set_title('reconstruction errors(ST-DAE)',fontsize=8)
plt.ylabel('error',fontsize=6,fontweight='bold')
# plt.legend()
plt.grid(linestyle = "--", alpha=0.5)
...
gs1.tight_layout(fig1, rect=[0, 0, 0.6, 1])
gs2.tight_layout(fig1, rect=[0.6, 0, 1, 1], h_pad=0.5)
